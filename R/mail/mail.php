...
$mail->Host = 'smtp.gmail.com';
            $mail->SMTPAuth = true;
            $mail->Username = 'bnruku08@gmail.com'; // Your email address
            $mail->Password = 'okej nmko vind rcer';   // Your email app password
            $mail->SMTPSecure = 'ssl'; // Encryption: 'ssl'
            $mail->Port = 465; // SMTP port (465 for SSL)
 
            // Email headers
            $mail->setFrom('bnruku08@gmail.com', 'FinTech'); // Sender's email and name
            $mail->addAddress($userEmail); // Recipient's email
 
            // Email subject and body
            $mail->Subject = 'Your OTP for Password Reset - FinTech';
           ...
           $mail->Body = "
                <div style='font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 30px; border-radius: 10px; max-width: 600px; margin: auto; box-shadow: 0 4px 8px rgba(0,0,0,0.1);'>
                    <div style='text-align: center;'>
                        <h1 style='color:rgb(63, 96, 139); margin-bottom: 10px;'>FinTech</h1>
                        <p style='color: #888; font-size: 14px; margin-top: 0;'>Your Trusted Partner in Business </p>
                    </div>
                    ...
                    <div style='text-align: left;'>
                        ...
                        <p style='font-size: 16px; font-weight: bold; color: #4CAF50;'>FINTECH Team</p>
                    </div>
                    <hr style='border: none; border-top: 1px solid #ddd; margin: 20px 0;'>
                    <div style='text-align: center; font-size: 12px; color: #999;'>
                        <p style='margin: 0;'>© " . date('Y') . "FINTECH. All rights reserved.</p>
